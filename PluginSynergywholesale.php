    ...
    public function getVariables()
    {
        $variables = [
            ...
            lang('Supported Features') => [
                ...
                'description' => implode('', [
                    '* ' . lang('TLD Lookup') . '<br>',
                    '* ' . lang('Domain Registration (.COM, .AU, .US and more)') . '<br>',
                    '* ' . lang('Domain Transfer') . '<br>',
                    '* ' . lang('Domain Renewal') . '<br>',
                    '* ' . lang('Domain Restore (expired / grace period)') . '<br>',
                    '* ' . lang('Existing Domain Importing') . '<br>',
                    '* ' . lang('Pricing Sync') . '<br>',
                    '* ' . lang('Get / Set Auto Renew Status') . '<br>',
                    '* ' . lang('Get / Set DNS Records (A, AAAA, MX, CNAME, TXT, SRV)') . '<br>',
                    '* ' . lang('Get / Set Nameserver Records') . '<br>',
                    '* ' . lang('Get / Set Contact Information') . '<br>',
                    '* ' . lang('Get / Set Registrar Lock') . '<br>',
                    '* ' . lang('Get / Set ID Protection (WHOIS Privacy)') . '<br>',
                    '* ' . lang('DNSSEC DS Record Management') . '<br>',
                    '* ' . lang('Glue Record / Child Host Management') . '<br>',
                    '* ' . lang('URL Forwarding') . '<br>',
